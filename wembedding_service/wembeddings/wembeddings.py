...
class WEmbeddings:
    ...
    MODELS_MAP = {
        ...
        "bert-base-multilingual-cased-finetuned-amharic": ("Davlan/bert-base-multilingual-cased-finetuned-amharic", -4, None),
        "am-roberta": ("uhhlt/am-roberta", -4, None)
    }
        ...
        def load(self):
            ...
            with self._loader_lock:
                ...
                self._transformers_model = transformers.TFAutoModel.from_pretrained(
                    self._transformers_model_name, from_pt=True,
